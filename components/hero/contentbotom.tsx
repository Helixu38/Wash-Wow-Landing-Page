  ...
  return (
    <div className="flex items-center justify-center px-4 text-primary">
      <div className="flex flex-col">
        ...
        {/* Section 4 */}
        <div className="flex flex-col">
          <div className="flex flex-row small-mobile:justify-center sm:justify-center md:items-star">
            <Image
              src="/img/hero/4.png"
              alt="Hero Image"
              width={134.4}
          ...
          <div className="flex flex-col small-mobile:text-center sm:text-center">
            <h2 className="font-bold small-mobile:text-lg sm:text-3xl mt-[14px]">
              Theo dõi tình trạng và đơn hàng tiện lợi
            </h2>
            <p className="font-medium small-mobile:text-base sm:text-lg my-[25px]">
          ...
          <Button className="bg-primary text-lg small-mobile:mx-[60px] sm:mx-[60px] h-[45px] rounded-xl mb-[61px]">
            Đăng ký ngay
          </Button>
        </div>
      </div>
